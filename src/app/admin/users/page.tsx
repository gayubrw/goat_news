...
import { Search, Trash2, Mail, UserCheck, ShieldAlert, Loader2 } from 'lucide-react';
        ...
        <AlertDialogHeader>
          ...
          <div className="space-y-4">
            <div className="text-sm text-muted-foreground">
              ...
              to admin role. This will grant them full administrative privileges.
            </div>
...
const DeleteConfirmDialog = ({ onConfirm, user }: { onConfirm: () => void; user: EnrichedUser }) => (
  <AlertDialog>
    <AlertDialogTrigger asChild>
    ...
    <AlertDialogContent>
      <AlertDialogHeader>
        ...
        <AlertDialogDescription>
          ...
          {user.profile?.lastName}? This action cannot be undone and will
...
const UsersPage = () => {
  ...
  const handleRoleChange = async (userId: string, newRole: string) => {
    try {
      ...
      toast({
        title: 'Success',
        description: newRole === 'admin' ? 'User has been promoted to admin successfully' : 'User role updated successfully',
      });
    } catch (error) {
      console.error(error);
      toast({
        ...
        <Table>
          <TableHeader>
            <TableRow className="border-border hover:bg-muted/50">
              <TableHead className="text-muted-foreground w-72">User</TableHead>
